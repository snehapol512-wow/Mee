...
public class BinarySearchTree {
    ...
    static TreeNode insert(TreeNode root, int key){
        ...
        // 1 Empty tree-> return root node which is null
        ...
        public static TreeNode deleteNode(TreeNode root, int key) {
            ...
            if (key < root.data) {
                ...
                //Replace the root data with inorder successor
                root.data = temp.data;
                //While doing this we will end up with a duplicate , delete the duplicate that
                // already exists in the right subtree
    ...
    public static void main(String[] args) {
        ...
        inOrder(root);
        System.out.println();
        TreeNode result = search(root,106);
        if(result == null) {
